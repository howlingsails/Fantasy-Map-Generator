window.COArenderer = (function () {
  ...
  const patterns = {
    ...
    ermine: (p, c1, c2, size) => `<pattern id="${p}" width="${size * 0.125}" height="${
      size * 0.125
    ...
    plumetty: (p, c1, c2, size) => `<pattern id="${p}" width="${size * 0.125}" height="${
      size * 0.25
    ...
    maily: (p, c1, c2, size) => `<pattern id="${p}" width="${size * 0.167}" height="${
      size * 0.167
  ...
  const draw = async function (id, coa) {
    const {
      shield, division, ordinaries = [], charges = [],
    } = coa;
