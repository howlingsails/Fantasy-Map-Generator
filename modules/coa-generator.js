window.COA = (function () {
  const tinctures = {
    field: {
      metals: 3, colours: 4, stains: +P(0.03), patterns: 1,
    },
    division: {
      metals: 5, colours: 8, stains: +P(0.03), patterns: 1,
    },
    charge: {
      metals: 2, colours: 3, stains: +P(0.05), patterns: 0,
    },
    metals: { argent: 3, or: 2 },
    colours: {
      gules: 5, azure: 4, sable: 3, purpure: 3, vert: 2,
    },
  ...
  const charges = {
    ...
    types: {
      conventional: 30, crosses: 10, animals: 2, animalHeads: 1, birds: 2, fantastic: 3, plants: 1, agriculture: 1, arms: 3, bodyparts: 1, people: 1, architecture: 1, miscellaneous: 3, inescutcheon: 3,
    },
    single: {
      conventional: 12, crosses: 8, plants: 2, animals: 10, animalHeads: 2, birds: 4, fantastic: 7, agriculture: 1, arms: 6, bodyparts: 1, people: 2, architecture: 1, miscellaneous: 10, inescutcheon: 5,
    },
    ...
    animalHeads: {
      wolfHeadErased: 1, bullHeadCaboshed: 1, deerHeadCaboshed: 1, lionHeadCaboshed: 2,
    },
    fantastic: {
      dragonPassant: 2, dragonRampant: 2, wyvern: 1, wyvernWithWingsDisplayed: 1, griffinPassant: 1, griffinRampant: 1, eagleTwoHeards: 2, unicornRampant: 1, pegasus: 1, serpent: 1,
    },
    birds: {
      eagle: 9, raven: 1, cock: 3, parrot: 1, swan: 2, swanErased: 1, heron: 1, owl: 1,
    },
    plants: {
      tree: 1, oak: 1, cinquefoil: 1, rose: 1,
    },
    agriculture: { garb: 1, rake: 1 },
    arms: {
      sword: 5, sabre: 1, sabresCrossed: 1, hatchet: 2, axe: 2, lochaberAxe: 1, mallet: 1, bowWithArrow: 2, bow: 1, arrow: 1, arrowsSheaf: 1, helmet: 2,
    },
    ...
    Naval: {
      anchor: 3, boat: 1, lymphad: 2, armillarySphere: 1, escallop: 1, dolphin: 1,
    },
    Highland: {
      tower: 1, raven: 1, wolfHeadErased: 1, wolfPassant: 1, goat: 1, axe: 1,
    },
    River: {
      tower: 1, garb: 1, rake: 1, boat: 1, pike: 2, bullHeadCaboshed: 1,
    },
    Lake: {
      cancer: 2, escallop: 1, pike: 2, heron: 1, boat: 1, boat2: 2,
    },
    Nomadic: {
      pot: 1, buckle: 1, wheel: 2, sabre: 2, sabresCrossed: 1, bow: 2, arrow: 1, horseRampant: 1, horseSalient: 1, crescent: 1, camel: 3,
    },
    Hunting: {
      bugleHorn: 2, bugleHorn2: 1, stagsAttires: 2, attire: 2, hatchet: 1, bowWithArrow: 1, arrowsSheaf: 1, deerHeadCaboshed: 1, wolfStatant: 1, oak: 1,
    },
    // selection based on type
    City: {
      key: 3, bell: 2, lute: 1, tower: 1, castle: 1, mallet: 1,
    },
    Capital: {
      crown: 4, orb: 1, lute: 1, castle: 3, tower: 1,
    },
    Сathedra: {
      chalice: 1, orb: 1, crosier: 2, lamb: 1, monk: 2, angel: 3, crossLatin: 2, crossPatriarchal: 1, crossOrthodox: 1, crossCalvary: 1,
    },
    // specific cases
  ...
  const positions = {
    conventional: {
      e: 20, abcdefgzi: 3, beh: 3, behdf: 2, acegi: 1, kn: 3, bhdf: 1, jeo: 1, abc: 3, jln: 6, jlh: 3, kmo: 2, jleh: 1, def: 3, abcpqh: 4, ABCDEFGHIJKL: 1,
    },
    complex: {
      e: 40, beh: 1, kn: 1, jeo: 1, abc: 2, jln: 7, jlh: 2, def: 1, abcpqh: 1,
    },
    divisions: {
      perPale: {
        e: 15, pq: 5, jo: 2, jl: 2, ABCDEFGHIJKL: 1,
      },
      perFess: {
        e: 12, kn: 4, jkl: 2, gizgiz: 1, jlh: 3, kmo: 1, ABCDEFGHIJKL: 1,
      },
      perBend: { e: 5, lm: 5, bcfdgh: 1 },
      perBendSinister: { e: 1, jo: 1 },
      perCross: {
        e: 4, jlmo: 1, j: 1, jo: 2, jl: 1,
      },
      perChevron: {
        e: 1, jlh: 1, dfk: 1, dfbh: 2, bdefh: 1,
      },
      perChevronReversed: {
        e: 1, mok: 2, dfh: 2, dfbh: 1, bdefh: 1,
      },
      perSaltire: {
        bhdf: 8, e: 3, abcdefgzi: 1, bh: 1, df: 1, ABCDEFGHIJKL: 1,
      },
      perPile: {
        ee: 3, be: 2, abceh: 1, abcabc: 1, jleh: 1,
      },
    },
    ordinariesOn: {
      pale: {
        ee: 12, beh: 10, kn: 3, bb: 1,
      },
      fess: { ee: 1, def: 3 },
      bar: { defdefdef: 1 },
    ...
    ordinariesOff: {
      ...
      fess: { abc: 3, abcz: 1 },
      bar: {
        abc: 2, abcgzi: 1, jlh: 5, bgi: 2, ach: 1,
      },
      gemelle: { abc: 1 },
      bend: { ccg: 2, ccc: 1 },
      ...
      bordure: {
        e: 4, jleh: 2, kenken: 1, peqpeq: 1,
      },
      orle: {
        e: 4, jleh: 1, kenken: 1, peqpeq: 1,
      },
      chief: { emo: 2, emoz: 1, ez: 2 },
      terrace: { e: 5, def: 1, bdf: 3 },
      mount: { e: 5, def: 1, bdf: 3 },
      point: {
        e: 2, def: 1, bdf: 3, acbdef: 1,
      },
      flaunches: { e: 3, kn: 1, beh: 3 },
      gyron: { bh: 1 },
      quarter: { e: 1 },
      canton: {
        e: 5, beh: 1, def: 1, bdefh: 1, kn: 1,
      },
      cross: { acgi: 1 },
      ...
      label: {
        defgzi: 2, eh: 3, defdefhmo: 1, egiegi: 1, pqn: 5,
      },
    },
    // charges
    inescutcheon: { e: 4, jln: 1 },
    mascle: {
      e: 15, abcdefgzi: 3, beh: 3, bdefh: 4, acegi: 1, kn: 3, joe: 2, abc: 3, jlh: 8, jleh: 1, df: 3, abcpqh: 4, pqe: 3, eknpq: 3,
    },
    lionRampant: {
      e: 10, def: 2, abc: 2, bdefh: 1, kn: 1, jlh: 2, abcpqh: 1,
    },
    lionPassant: {
      e: 10, def: 1, abc: 1, bdefh: 1, jlh: 1, abcpqh: 1,
    },
    wolfPassant: {
      e: 10, def: 1, abc: 1, bdefh: 1, jlh: 1, abcpqh: 1,
    },
    ...
    boarRampant: {
      e: 12, beh: 1, kn: 1, jln: 2,
    },
    eagle: {
      e: 15, beh: 1, kn: 1, abc: 1, jlh: 2, def: 2, pq: 1,
    },
    raven: {
      e: 15, beh: 1, kn: 1, jeo: 1, abc: 3, jln: 3, def: 1,
    },
    wyvern: { e: 10, jln: 1 },
    garb: {
      e: 1, def: 3, abc: 2, beh: 1, kn: 1, jln: 3, jleh: 1, abcpqh: 1, joe: 1, lme: 1,
    },
    crown: {
      e: 10, abcdefgzi: 1, beh: 3, behdf: 2, acegi: 1, kn: 1, pq: 2, abc: 1, jln: 4, jleh: 1, def: 2, abcpqh: 3,
    },
    hand: {
      e: 10, jln: 2, kn: 1, jeo: 1, abc: 2, pqe: 1,
    },
    armillarySphere: { e: 1 },
    tree: { e: 1 },
    lymphad: { e: 1 },
  ...
  const divisions = {
    variants: {
      perPale: 5, perFess: 5, perBend: 2, perBendSinister: 1, perChevron: 1, perChevronReversed: 1, perCross: 5, perPile: 1, perSaltire: 1, gyronny: 1, chevronny: 1,
    },
    perPale: lines,
    perFess: lines,
    perBend: lines,
    ...
    perCross: {
      straight: 20, wavy: 5, engrailed: 4, invecked: 3, rayonne: 1, embattled: 1, raguly: 1, urdy: 1, indented: 2, dentilly: 1, bevilled: 1, angled: 1, embattledGhibellin: 1, embattledGrady: 1, dovetailedIndented: 1, dovetailed: 1, potenty: 1, potentyDexter: 1, potentySinister: 1, nebuly: 1,
    },
    perPile: lines,
  };
  ...
  const shields = {
    types: {
      basic: 10, regional: 2, historical: 1, specific: 1, banner: 1, simple: 2, fantasy: 1, middleEarth: 0,
    },
    basic: { heater: 12, spanish: 6, french: 1 },
    regional: {
      horsehead: 1, horsehead2: 1, polish: 1, hessen: 1, swiss: 1,
    },
    historical: {
      boeotian: 1, roman: 2, kite: 1, oldFrench: 5, renaissance: 2, baroque: 2,
    },
    specific: {
      targe: 1, targe2: 0, pavise: 5, wedged: 10,
    },
    banner: {
      flag: 1, pennon: 0, guidon: 0, banner: 0, dovetail: 1, gonfalon: 5, pennant: 0,
    },
    simple: {
      round: 12, oval: 6, vesicaPiscis: 1, square: 1, diamond: 2, no: 0,
    },
    fantasy: {
      fantasy1: 2, fantasy2: 2, fantasy3: 1, fantasy4: 1, fantasy5: 3,
    },
    middleEarth: {
      noldor: 1, gondor: 1, easterling: 1, erebor: 1, ironHills: 1, urukHai: 1, moriaOrc: 1,
    },
  };
  ...
  const generate = function (parent, kinship, dominion, type) {
    ...
    let charge = !!P(usedPattern ? 0.5 : 0.93); // 80% for charge
    const linedOrdinary = (charge && P(0.3)) || P(0.5) ? (parent?.ordinaries && P(kinship) ? parent.ordinaries[0].ordinary : rw(ordinaries.lined)) : null;
    const ordinary = (!charge && P(0.65)) || P(0.3) ? (linedOrdinary || rw(ordinaries.straight)) : null; // 36% for ordinary
      ...
      if (p === 'ABCDEFGHIKL' && P(0.95)) {
        ...
        if (P(0.3) && ['perPale', 'perFess'].includes(division) && coa.line === 'straight') {
          ...
          if (P(0.95)) {
            ...
            coa.charges.push({
              charge, t, p: p2, divided: 'division',
            });
          }
  ...
  return {
    generate, toString, copy, getShield, shields,
  };
}());
