function createRiver() {
  ...
  function addRiver() {
    ...
    const {
      addMeandering, getApproximateLength, getWidth, getOffset, getName, getRiverPath, getBasin,
    } = Rivers;
    ...
    rivers.push({
      i: riverId, source, mouth, discharge, length, width, widthFactor, sourceWidth, parent, cells: riverCells, basin, name, type: 'River',
    });
