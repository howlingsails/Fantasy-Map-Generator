function editHeightmap() {
  ...
  function moveCursor() {
    ...
    const cell = findGridCell(p[0], p[1]);
  ...
  function openTemplateEditor() {
    ...
    $('#templateBody').sortable({
      items: '> div', handle: '.icon-resize-vertical', containment: '#templateBody', axis: 'y',
    });
    ...
    function executeTemplate() {
      ...
      const {
        addHill, addPit, addRange, addTrough, addStrait, modify, smooth,
      } = HeightmapGenerator;
  ...
  function openImageConverter() {
    ...
    function autoAssing(type) {
      ...
      const getHeightByScheme = function (color) {
        const height = scheme.indexOf(color);
