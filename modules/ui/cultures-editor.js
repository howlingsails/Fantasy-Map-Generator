function editCultures() {
    ...
    $('#alert').dialog({
      ...
      buttons: {
        Remove() {
          ...
          const { origin } = pack.cultures[culture];
  ...
  function drawCultureCenters() {
    ...
    const cultureCenters = debug.append('g').attr('id', 'cultureCenters').attr('stroke-width', 2).attr('stroke', '#444444')
      .style('cursor', 'move');
    ...
    function renderTree() {
      ...
      node
        ...
        .attr('d', (d) => {
          ...
          // small circle
          if (d.data.type === 'Generic') return 'M11.3,0A11.3,11.3,0,1,1,-11.3,0A11.3,11.3,0,1,1,11.3,0';
          // circle
          if (d.data.type === 'River') return 'M0,-14L14,0L0,14L-14,0Z';
          // diamond
          if (d.data.type === 'Lake') return 'M-6.5,-11.26l13,0l6.5,11.26l-6.5,11.26l-13,0l-6.5,-11.26Z';
          // hexagon
