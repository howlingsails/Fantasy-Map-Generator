  ...
  function militaryCustomize() {
    ...
    $('#militaryOptions').dialog({
      ...
      buttons: {
        ...
        Add: () => addUnitLine({
          icon: '🛡️', name: `custom${militaryOptionsTable.rows.length}`, rural: 0.2, urban: 0.5, crew: 1, power: 1, type: 'melee',
        }),
    ...
    function addUnitLine(unit) {
      ...
      const getLimitButton = (attr) => `<button 
    ...
    function applyMilitaryOptions() {
      ...
      options.military = unitLines.map((r, i) => {
        ...
        const unit = {
          icon, name: names[i], rural, urban, crew, power, type, separate,
        };
