window.Rivers = (function () {
  const generate = function (allowErosion = true) {
    ...
    function defineRivers() {
      ...
      for (const key in riversData) {
        ...
        pack.rivers.push({
          i: riverId, source, mouth, discharge, length, width, widthFactor, sourceWidth: 0, parent, cells: riverCells,
        });
      }
    }
  ...
  return {
    generate, alterHeights, resolveDepressions, addMeandering, getRiverPath, specify, getName, getType, getBasin, getWidth, getOffset, getApproximateLength, getRiverPoints, remove,
  };
}());
